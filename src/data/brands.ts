...
const brands: Brand[] = [
  {
    ...
    logo: {
      path: "/logos/snipppLogo.svg",

      variants: [
        {
          name: "Extended Logo",
          imagePath: "/logos/snippp.svg",
        },
        {
          name: "Favicon",
          imagePath: "/logos/snipppFavicon.svg",
        },
      ],
    },
    colors: [
  ...
  },
  {
    ...
    logo: {
      path: "/logos/cocoonSimpleLogo.svg",
      variants: [
        {
          name: "Abberated Logo",
          imagePath: "/logos/cocoonLogo.svg",
        },
        {
          name: "Favicon",
          imagePath: "/logos/cocoonFavicon.svg",
        },
      ],
    ...
    elements: [
      ...
      },
      {
        name: "Tooltips",
        imagePath: [
          "/elements/cocoon/cocoonTooltipClearData.png",
          "/elements/cocoon/cocoonTooltipDownvote.png",
          "/elements/cocoon/cocoonScannerTooltip.png",
        ],
      ...
      {
        name: "Project Cards",
        imagePath: ["/elements/cocoon/cocoonProjectCard.png"],
      ...
      {
        name: "Path Display",
        imagePath: ["/elements/cocoon/cocoonPath.png"],
      ...
      },
      {
        ...
        imagePath: [
          "/elements/cocoon/cocoonScannerCopy.png",
          "/elements/cocoon/cocoonEmptyFeature.png",
          "/elements/cocoon/cocoonSurveyCopy.png",
        ],
      ...
      },
      {
        name: "Empty Sections",
        imagePath: [
          "/elements/cocoon/cocoonIncompleteSection.png",
          "/elements/cocoon/cocoonPartiallyCompleteSection.png",
          "/elements/cocoon/cocoonMostlyCompleteSection.png",
        ],
  ...
  },
  {
    ...
    mission:
      "Establish an easy to use product development pipeline for startups and small businesses.",
    logo: {
      path: "/logos/flashmateLogo.svg",
      variants: [
        {
          name: "Simple Logo",
          imagePath: "/logos/flashmateLogoSimple.svg",
        },
      ],
